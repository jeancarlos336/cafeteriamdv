...
urlpatterns = [
    ...
    path(
        "productos/actualizar/<int:id_producto>/",
        actualizar_producto,
    ...
    path(
        "categorias/actualizar/<int:id_categoria>/",
        actualizar_categoria,
        name="actualizar_categoria",
    ),
    # Otras rutas
    path(
        "obtener_precio_producto/<int:producto_id>/",
        obtener_precio_producto,
        name="obtener_precio_producto",
    ),
    path(
        "generar_boleta_impresion/<int:id_venta>/",
        views.generar_boleta_impresion,
        name="generar_boleta_impresion",
    ),
