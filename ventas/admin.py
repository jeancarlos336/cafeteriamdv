...
class VentaAdmin(admin.ModelAdmin):
    list_display = ('id_venta', 'fecha', 'cliente', 'total')  # Campos a mostrar en la lista de ventas
...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ('id_producto', 'nom_producto', 'costo_producto', 'valor_venta', 'id_categoria')  # Campos a mostrar en la lista de productos
    search_fields = ('nom_producto',)  # Permite buscar por nombre de producto

class CategoriaProductoAdmin(admin.ModelAdmin):
    list_display = ('id_categoria', 'nomb_categoria')  # Campos a mostrar en la lista de categorías
